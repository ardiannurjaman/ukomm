                ...
                <div class="card-footer text-center">
                    <?php
                        ...
                        if (mysqli_num_rows($ceksuka) == 1){ ?>
                             <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid']?>" type="submit" name="batalsuka"><i class="fa-solid fa-heart"></i></a>
                       <?php }else{ ?>
            ...
            <div class="m-2">
              <div class="overflow-auto">
                <div class="sticky-top">
                  ...
                  <span class="badge bg-danger"><?php echo $data['namalengkap']?></span>
                  ...
                  <form action="../config/proses_komentar.php" method="POST">
                    <div class="input-group">
                      ...
                      <div class="input-group-prepend">
                        <button type="submit" name="kirimkomentar" class="btn btn-success">Kirim</button>
                      </div>
                    </div>
                  </form>
                </div>
